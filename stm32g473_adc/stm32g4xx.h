...
enum {
	ADC_CFGR_JQDIS = 1UL<<31, // Injected Queue disable
	ADC_CFGR_AWD1CH = ((1UL<<5)-1) << 26, // Analog watchdog 1 channel selection
	...
	ADC_CFGR_ALIGN = 1UL<<15, // ALIGN
	ADC_CFGR_AUTDLY = 1UL<<14, // AUTDLY
	ADC_CFGR_CONT = 1UL<<13, // CONT
	ADC_CFGR_OVRMOD = 1UL<<12, // OVRMOD
	ADC_CFGR_EXTEN = ((1UL<<2)-1) << 10, // EXTEN
	ADC_CFGR_EXTSEL = ((1UL<<5)-1) << 5, // External trigger selection for regular group
	ADC_CFGR_RES = ((1UL<<2)-1) << 3, // RES
	ADC_CFGR_DMACFG = 1UL<<1, // DMACFG
	ADC_CFGR_DMAEN = 1UL<<0, // DMAEN		
};
static inline void adc_cfgr_set_awd1ch(struct ADC_Type* p, uint32_t val) { p->CFGR = (p->CFGR & ~ADC_CFGR_AWD1CH) | ((val<<26) & ADC_CFGR_AWD1CH); }
static inline void adc_cfgr_set_discnum(struct ADC_Type* p, uint32_t val) { p->CFGR = (p->CFGR & ~ADC_CFGR_DISCNUM) | ((val<<17) & ADC_CFGR_DISCNUM); }
static inline void adc_cfgr_set_exten(struct ADC_Type* p, uint32_t val) { p->CFGR = (p->CFGR & ~ADC_CFGR_EXTEN) | ((val<<10) & ADC_CFGR_EXTEN); }
static inline void adc_cfgr_set_extsel(struct ADC_Type* p, uint32_t val) { p->CFGR = (p->CFGR & ~ADC_CFGR_EXTSEL) | ((val<<5) & ADC_CFGR_EXTSEL); }
static inline void adc_cfgr_set_res(struct ADC_Type* p, uint32_t val) { p->CFGR = (p->CFGR & ~ADC_CFGR_RES) | ((val<<3) & ADC_CFGR_RES); }
static inline uint32_t adc_cfgr_get_awd1ch(struct ADC_Type* p) { return (p->CFGR & ADC_CFGR_AWD1CH) >> 26 ; }
static inline uint32_t adc_cfgr_get_discnum(struct ADC_Type* p) { return (p->CFGR & ADC_CFGR_DISCNUM) >> 17 ; }
static inline uint32_t adc_cfgr_get_exten(struct ADC_Type* p) { return (p->CFGR & ADC_CFGR_EXTEN) >> 10 ; }
static inline uint32_t adc_cfgr_get_extsel(struct ADC_Type* p) { return (p->CFGR & ADC_CFGR_EXTSEL) >> 5 ; }
static inline uint32_t adc_cfgr_get_res(struct ADC_Type* p) { return (p->CFGR & ADC_CFGR_RES) >> 3 ; }

// ADC->CFGR2 configuration register
enum {
	ADC_CFGR2_SMPTRIG = 1UL<<27, // SMPTRIG
	ADC_CFGR2_BULB = 1UL<<26, // BULB
	ADC_CFGR2_SWTRIG = 1UL<<25, // SWTRIG
	ADC_CFGR2_GCOMP = 1UL<<16, // GCOMP
	ADC_CFGR2_ROVSM = 1UL<<10, // EXTEN
	ADC_CFGR2_TROVS = 1UL<<9, // Triggered Regular Oversampling
	ADC_CFGR2_OVSS = ((1UL<<4)-1) << 5, // ALIGN
	ADC_CFGR2_OVSR = ((1UL<<3)-1) << 2, // RES
	ADC_CFGR2_JOVSE = 1UL<<1, // DMACFG
	ADC_CFGR2_ROVSE = 1UL<<0, // DMAEN		
};
static inline void adc_cfgr2_set_ovss(struct ADC_Type* p, uint32_t val) { p->CFGR2 = (p->CFGR2 & ~ADC_CFGR2_OVSS) | ((val<<5) & ADC_CFGR2_OVSS); }
static inline void adc_cfgr2_set_ovsr(struct ADC_Type* p, uint32_t val) { p->CFGR2 = (p->CFGR2 & ~ADC_CFGR2_OVSR) | ((val<<2) & ADC_CFGR2_OVSR); }
static inline uint32_t adc_cfgr2_get_ovss(struct ADC_Type* p) { return (p->CFGR2 & ADC_CFGR2_OVSS) >> 5 ; }
static inline uint32_t adc_cfgr2_get_ovsr(struct ADC_Type* p) { return (p->CFGR2 & ADC_CFGR2_OVSR) >> 2 ; }

// ADC->SMPR1 sample time register 1
enum {
	ADC_SMPR1_SMPPLUS = 1UL<<31, // Addition of one clock cycle to the sampling time
...
static inline void adc_smpr1_set_smp9(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP9) | ((val<<27) & ADC_SMPR1_SMP9); }
static inline void adc_smpr1_set_smp8(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP8) | ((val<<24) & ADC_SMPR1_SMP8); }
static inline void adc_smpr1_set_smp7(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP7) | ((val<<21) & ADC_SMPR1_SMP7); }
static inline void adc_smpr1_set_smp6(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP6) | ((val<<18) & ADC_SMPR1_SMP6); }
static inline void adc_smpr1_set_smp5(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP5) | ((val<<15) & ADC_SMPR1_SMP5); }
static inline void adc_smpr1_set_smp4(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP4) | ((val<<12) & ADC_SMPR1_SMP4); }
static inline void adc_smpr1_set_smp3(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP3) | ((val<<9) & ADC_SMPR1_SMP3); }
static inline void adc_smpr1_set_smp2(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP2) | ((val<<6) & ADC_SMPR1_SMP2); }
static inline void adc_smpr1_set_smp1(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP1) | ((val<<3) & ADC_SMPR1_SMP1); }
static inline void adc_smpr1_set_smp0(struct ADC_Type* p, uint32_t val) { p->SMPR1 = (p->SMPR1 & ~ADC_SMPR1_SMP0) | ((val<<0) & ADC_SMPR1_SMP0); }
static inline uint32_t adc_smpr1_get_smp9(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP9) >> 27 ; }
static inline uint32_t adc_smpr1_get_smp8(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP8) >> 24 ; }
static inline uint32_t adc_smpr1_get_smp7(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP7) >> 21 ; }
static inline uint32_t adc_smpr1_get_smp6(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP6) >> 18 ; }
static inline uint32_t adc_smpr1_get_smp5(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP5) >> 15 ; }
static inline uint32_t adc_smpr1_get_smp4(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP4) >> 12 ; }
static inline uint32_t adc_smpr1_get_smp3(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP3) >> 9 ; }
static inline uint32_t adc_smpr1_get_smp2(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP2) >> 6 ; }
static inline uint32_t adc_smpr1_get_smp1(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP1) >> 3 ; }
static inline uint32_t adc_smpr1_get_smp0(struct ADC_Type* p) { return (p->SMPR1 & ADC_SMPR1_SMP0) >> 0 ; }
...
static inline void adc_smpr2_set_smp18(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP18) | ((val<<24) & ADC_SMPR2_SMP18); }
static inline void adc_smpr2_set_smp17(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP17) | ((val<<21) & ADC_SMPR2_SMP17); }
static inline void adc_smpr2_set_smp16(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP16) | ((val<<18) & ADC_SMPR2_SMP16); }
static inline void adc_smpr2_set_smp15(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP15) | ((val<<15) & ADC_SMPR2_SMP15); }
static inline void adc_smpr2_set_smp14(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP14) | ((val<<12) & ADC_SMPR2_SMP14); }
static inline void adc_smpr2_set_smp13(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP13) | ((val<<9) & ADC_SMPR2_SMP13); }
static inline void adc_smpr2_set_smp12(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP12) | ((val<<6) & ADC_SMPR2_SMP12); }
static inline void adc_smpr2_set_smp11(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP11) | ((val<<3) & ADC_SMPR2_SMP11); }
static inline void adc_smpr2_set_smp10(struct ADC_Type* p, uint32_t val) { p->SMPR2 = (p->SMPR2 & ~ADC_SMPR2_SMP10) | ((val<<0) & ADC_SMPR2_SMP10); }
static inline uint32_t adc_smpr2_get_smp18(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP18) >> 24 ; }
static inline uint32_t adc_smpr2_get_smp17(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP17) >> 21 ; }
static inline uint32_t adc_smpr2_get_smp16(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP16) >> 18 ; }
static inline uint32_t adc_smpr2_get_smp15(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP15) >> 15 ; }
static inline uint32_t adc_smpr2_get_smp14(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP14) >> 12 ; }
static inline uint32_t adc_smpr2_get_smp13(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP13) >> 9 ; }
static inline uint32_t adc_smpr2_get_smp12(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP12) >> 6 ; }
static inline uint32_t adc_smpr2_get_smp11(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP11) >> 3 ; }
static inline uint32_t adc_smpr2_get_smp10(struct ADC_Type* p) { return (p->SMPR2 & ADC_SMPR2_SMP10) >> 0 ; }

// ADC->TR1 watchdog threshold register 1
enum {
	ADC_TR1_HT1 = ((1UL<<12)-1) << 16, // HT1
	ADC_TR1_AWDFILT = ((1UL<<3)-1) << 12, // AWDFILT
	ADC_TR1_LT1 = ((1UL<<12)-1) << 0, // LT1		
};
static inline void adc_tr1_set_ht1(struct ADC_Type* p, uint32_t val) { p->TR1 = (p->TR1 & ~ADC_TR1_HT1) | ((val<<16) & ADC_TR1_HT1); }
static inline void adc_tr1_set_awdfilt(struct ADC_Type* p, uint32_t val) { p->TR1 = (p->TR1 & ~ADC_TR1_AWDFILT) | ((val<<12) & ADC_TR1_AWDFILT); }
static inline void adc_tr1_set_lt1(struct ADC_Type* p, uint32_t val) { p->TR1 = (p->TR1 & ~ADC_TR1_LT1) | ((val<<0) & ADC_TR1_LT1); }
static inline uint32_t adc_tr1_get_ht1(struct ADC_Type* p) { return (p->TR1 & ADC_TR1_HT1) >> 16 ; }
static inline uint32_t adc_tr1_get_awdfilt(struct ADC_Type* p) { return (p->TR1 & ADC_TR1_AWDFILT) >> 12 ; }
static inline uint32_t adc_tr1_get_lt1(struct ADC_Type* p) { return (p->TR1 & ADC_TR1_LT1) >> 0 ; }
...
static inline void adc_tr2_set_ht2(struct ADC_Type* p, uint32_t val) { p->TR2 = (p->TR2 & ~ADC_TR2_HT2) | ((val<<16) & ADC_TR2_HT2); }
static inline void adc_tr2_set_lt2(struct ADC_Type* p, uint32_t val) { p->TR2 = (p->TR2 & ~ADC_TR2_LT2) | ((val<<0) & ADC_TR2_LT2); }
static inline uint32_t adc_tr2_get_ht2(struct ADC_Type* p) { return (p->TR2 & ADC_TR2_HT2) >> 16 ; }
static inline uint32_t adc_tr2_get_lt2(struct ADC_Type* p) { return (p->TR2 & ADC_TR2_LT2) >> 0 ; }
...
static inline void adc_tr3_set_ht3(struct ADC_Type* p, uint32_t val) { p->TR3 = (p->TR3 & ~ADC_TR3_HT3) | ((val<<16) & ADC_TR3_HT3); }
static inline void adc_tr3_set_lt3(struct ADC_Type* p, uint32_t val) { p->TR3 = (p->TR3 & ~ADC_TR3_LT3) | ((val<<0) & ADC_TR3_LT3); }
static inline uint32_t adc_tr3_get_ht3(struct ADC_Type* p) { return (p->TR3 & ADC_TR3_HT3) >> 16 ; }
static inline uint32_t adc_tr3_get_lt3(struct ADC_Type* p) { return (p->TR3 & ADC_TR3_LT3) >> 0 ; }
...
enum {
	...
	ADC_SQR1_L = ((1UL<<4)-1) << 0, // Regular channel sequence length		
};
static inline void adc_sqr1_set_sq4(struct ADC_Type* p, uint32_t val) { p->SQR1 = (p->SQR1 & ~ADC_SQR1_SQ4) | ((val<<24) & ADC_SQR1_SQ4); }
static inline void adc_sqr1_set_sq3(struct ADC_Type* p, uint32_t val) { p->SQR1 = (p->SQR1 & ~ADC_SQR1_SQ3) | ((val<<18) & ADC_SQR1_SQ3); }
static inline void adc_sqr1_set_sq2(struct ADC_Type* p, uint32_t val) { p->SQR1 = (p->SQR1 & ~ADC_SQR1_SQ2) | ((val<<12) & ADC_SQR1_SQ2); }
static inline void adc_sqr1_set_sq1(struct ADC_Type* p, uint32_t val) { p->SQR1 = (p->SQR1 & ~ADC_SQR1_SQ1) | ((val<<6) & ADC_SQR1_SQ1); }
static inline void adc_sqr1_set_l(struct ADC_Type* p, uint32_t val) { p->SQR1 = (p->SQR1 & ~ADC_SQR1_L) | ((val<<0) & ADC_SQR1_L); }
static inline uint32_t adc_sqr1_get_sq4(struct ADC_Type* p) { return (p->SQR1 & ADC_SQR1_SQ4) >> 24 ; }
static inline uint32_t adc_sqr1_get_sq3(struct ADC_Type* p) { return (p->SQR1 & ADC_SQR1_SQ3) >> 18 ; }
static inline uint32_t adc_sqr1_get_sq2(struct ADC_Type* p) { return (p->SQR1 & ADC_SQR1_SQ2) >> 12 ; }
static inline uint32_t adc_sqr1_get_sq1(struct ADC_Type* p) { return (p->SQR1 & ADC_SQR1_SQ1) >> 6 ; }
static inline uint32_t adc_sqr1_get_l(struct ADC_Type* p) { return (p->SQR1 & ADC_SQR1_L) >> 0 ; }
...
static inline void adc_sqr2_set_sq9(struct ADC_Type* p, uint32_t val) { p->SQR2 = (p->SQR2 & ~ADC_SQR2_SQ9) | ((val<<24) & ADC_SQR2_SQ9); }
static inline void adc_sqr2_set_sq8(struct ADC_Type* p, uint32_t val) { p->SQR2 = (p->SQR2 & ~ADC_SQR2_SQ8) | ((val<<18) & ADC_SQR2_SQ8); }
static inline void adc_sqr2_set_sq7(struct ADC_Type* p, uint32_t val) { p->SQR2 = (p->SQR2 & ~ADC_SQR2_SQ7) | ((val<<12) & ADC_SQR2_SQ7); }
static inline void adc_sqr2_set_sq6(struct ADC_Type* p, uint32_t val) { p->SQR2 = (p->SQR2 & ~ADC_SQR2_SQ6) | ((val<<6) & ADC_SQR2_SQ6); }
static inline void adc_sqr2_set_sq5(struct ADC_Type* p, uint32_t val) { p->SQR2 = (p->SQR2 & ~ADC_SQR2_SQ5) | ((val<<0) & ADC_SQR2_SQ5); }
static inline uint32_t adc_sqr2_get_sq9(struct ADC_Type* p) { return (p->SQR2 & ADC_SQR2_SQ9) >> 24 ; }
static inline uint32_t adc_sqr2_get_sq8(struct ADC_Type* p) { return (p->SQR2 & ADC_SQR2_SQ8) >> 18 ; }
static inline uint32_t adc_sqr2_get_sq7(struct ADC_Type* p) { return (p->SQR2 & ADC_SQR2_SQ7) >> 12 ; }
static inline uint32_t adc_sqr2_get_sq6(struct ADC_Type* p) { return (p->SQR2 & ADC_SQR2_SQ6) >> 6 ; }
static inline uint32_t adc_sqr2_get_sq5(struct ADC_Type* p) { return (p->SQR2 & ADC_SQR2_SQ5) >> 0 ; }
...
static inline void adc_sqr3_set_sq14(struct ADC_Type* p, uint32_t val) { p->SQR3 = (p->SQR3 & ~ADC_SQR3_SQ14) | ((val<<24) & ADC_SQR3_SQ14); }
static inline void adc_sqr3_set_sq13(struct ADC_Type* p, uint32_t val) { p->SQR3 = (p->SQR3 & ~ADC_SQR3_SQ13) | ((val<<18) & ADC_SQR3_SQ13); }
static inline void adc_sqr3_set_sq12(struct ADC_Type* p, uint32_t val) { p->SQR3 = (p->SQR3 & ~ADC_SQR3_SQ12) | ((val<<12) & ADC_SQR3_SQ12); }
static inline void adc_sqr3_set_sq11(struct ADC_Type* p, uint32_t val) { p->SQR3 = (p->SQR3 & ~ADC_SQR3_SQ11) | ((val<<6) & ADC_SQR3_SQ11); }
static inline void adc_sqr3_set_sq10(struct ADC_Type* p, uint32_t val) { p->SQR3 = (p->SQR3 & ~ADC_SQR3_SQ10) | ((val<<0) & ADC_SQR3_SQ10); }
static inline uint32_t adc_sqr3_get_sq14(struct ADC_Type* p) { return (p->SQR3 & ADC_SQR3_SQ14) >> 24 ; }
static inline uint32_t adc_sqr3_get_sq13(struct ADC_Type* p) { return (p->SQR3 & ADC_SQR3_SQ13) >> 18 ; }
static inline uint32_t adc_sqr3_get_sq12(struct ADC_Type* p) { return (p->SQR3 & ADC_SQR3_SQ12) >> 12 ; }
static inline uint32_t adc_sqr3_get_sq11(struct ADC_Type* p) { return (p->SQR3 & ADC_SQR3_SQ11) >> 6 ; }
static inline uint32_t adc_sqr3_get_sq10(struct ADC_Type* p) { return (p->SQR3 & ADC_SQR3_SQ10) >> 0 ; }
...
static inline void adc_sqr4_set_sq16(struct ADC_Type* p, uint32_t val) { p->SQR4 = (p->SQR4 & ~ADC_SQR4_SQ16) | ((val<<6) & ADC_SQR4_SQ16); }
static inline void adc_sqr4_set_sq15(struct ADC_Type* p, uint32_t val) { p->SQR4 = (p->SQR4 & ~ADC_SQR4_SQ15) | ((val<<0) & ADC_SQR4_SQ15); }
static inline uint32_t adc_sqr4_get_sq16(struct ADC_Type* p) { return (p->SQR4 & ADC_SQR4_SQ16) >> 6 ; }
static inline uint32_t adc_sqr4_get_sq15(struct ADC_Type* p) { return (p->SQR4 & ADC_SQR4_SQ15) >> 0 ; }

// ADC->DR regular Data Register
enum {
	ADC_DR_RDATA = ((1UL<<16)-1) << 0, // Regular Data converted		
};
static inline uint32_t adc_dr_get_rdata(struct ADC_Type* p) { return (p->DR & ADC_DR_RDATA) >> 0 ; }

// ADC->JSQR injected sequence register
enum {
	ADC_JSQR_JSQ4 = ((1UL<<5)-1) << 27, // JSQ4
	ADC_JSQR_JSQ3 = ((1UL<<5)-1) << 21, // JSQ3
	ADC_JSQR_JSQ2 = ((1UL<<5)-1) << 15, // JSQ2
	ADC_JSQR_JSQ1 = ((1UL<<5)-1) << 9, // JSQ1
	ADC_JSQR_JEXTEN = ((1UL<<2)-1) << 7, // JEXTEN
	ADC_JSQR_JEXTSEL = ((1UL<<5)-1) << 2, // JEXTSEL
	ADC_JSQR_JL = ((1UL<<2)-1) << 0, // JL		
};
static inline void adc_jsqr_set_jsq4(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JSQ4) | ((val<<27) & ADC_JSQR_JSQ4); }
static inline void adc_jsqr_set_jsq3(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JSQ3) | ((val<<21) & ADC_JSQR_JSQ3); }
static inline void adc_jsqr_set_jsq2(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JSQ2) | ((val<<15) & ADC_JSQR_JSQ2); }
static inline void adc_jsqr_set_jsq1(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JSQ1) | ((val<<9) & ADC_JSQR_JSQ1); }
static inline void adc_jsqr_set_jexten(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JEXTEN) | ((val<<7) & ADC_JSQR_JEXTEN); }
static inline void adc_jsqr_set_jextsel(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JEXTSEL) | ((val<<2) & ADC_JSQR_JEXTSEL); }
static inline void adc_jsqr_set_jl(struct ADC_Type* p, uint32_t val) { p->JSQR = (p->JSQR & ~ADC_JSQR_JL) | ((val<<0) & ADC_JSQR_JL); }
static inline uint32_t adc_jsqr_get_jsq4(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JSQ4) >> 27 ; }
static inline uint32_t adc_jsqr_get_jsq3(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JSQ3) >> 21 ; }
static inline uint32_t adc_jsqr_get_jsq2(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JSQ2) >> 15 ; }
static inline uint32_t adc_jsqr_get_jsq1(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JSQ1) >> 9 ; }
static inline uint32_t adc_jsqr_get_jexten(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JEXTEN) >> 7 ; }
static inline uint32_t adc_jsqr_get_jextsel(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JEXTSEL) >> 2 ; }
static inline uint32_t adc_jsqr_get_jl(struct ADC_Type* p) { return (p->JSQR & ADC_JSQR_JL) >> 0 ; }

// ADC->OFR1 offset register 1
enum {
	ADC_OFR1_OFFSET1_EN = 1UL<<31, // OFFSET1_EN
	ADC_OFR1_OFFSET1_CH = ((1UL<<5)-1) << 26, // OFFSET1_CH
	ADC_OFR1_SATEN = 1UL<<25, // SATEN
	ADC_OFR1_OFFSETPOS = 1UL<<24, // OFFSETPOS
	ADC_OFR1_OFFSET1 = ((1UL<<12)-1) << 0, // OFFSET1		
};
static inline void adc_ofr1_set_offset1_ch(struct ADC_Type* p, uint32_t val) { p->OFR1 = (p->OFR1 & ~ADC_OFR1_OFFSET1_CH) | ((val<<26) & ADC_OFR1_OFFSET1_CH); }
static inline void adc_ofr1_set_offset1(struct ADC_Type* p, uint32_t val) { p->OFR1 = (p->OFR1 & ~ADC_OFR1_OFFSET1) | ((val<<0) & ADC_OFR1_OFFSET1); }
static inline uint32_t adc_ofr1_get_offset1_ch(struct ADC_Type* p) { return (p->OFR1 & ADC_OFR1_OFFSET1_CH) >> 26 ; }
static inline uint32_t adc_ofr1_get_offset1(struct ADC_Type* p) { return (p->OFR1 & ADC_OFR1_OFFSET1) >> 0 ; }

// ADC->OFR2 offset register 2
enum {
	ADC_OFR2_OFFSET1_EN = 1UL<<31, // OFFSET1_EN
	ADC_OFR2_OFFSET1_CH = ((1UL<<5)-1) << 26, // OFFSET1_CH
	ADC_OFR2_SATEN = 1UL<<25, // SATEN
	ADC_OFR2_OFFSETPOS = 1UL<<24, // OFFSETPOS
	ADC_OFR2_OFFSET1 = ((1UL<<12)-1) << 0, // OFFSET1		
};
static inline void adc_ofr2_set_offset1_ch(struct ADC_Type* p, uint32_t val) { p->OFR2 = (p->OFR2 & ~ADC_OFR2_OFFSET1_CH) | ((val<<26) & ADC_OFR2_OFFSET1_CH); }
static inline void adc_ofr2_set_offset1(struct ADC_Type* p, uint32_t val) { p->OFR2 = (p->OFR2 & ~ADC_OFR2_OFFSET1) | ((val<<0) & ADC_OFR2_OFFSET1); }
static inline uint32_t adc_ofr2_get_offset1_ch(struct ADC_Type* p) { return (p->OFR2 & ADC_OFR2_OFFSET1_CH) >> 26 ; }
static inline uint32_t adc_ofr2_get_offset1(struct ADC_Type* p) { return (p->OFR2 & ADC_OFR2_OFFSET1) >> 0 ; }

// ADC->OFR3 offset register 3
enum {
	ADC_OFR3_OFFSET1_EN = 1UL<<31, // OFFSET1_EN
	ADC_OFR3_OFFSET1_CH = ((1UL<<5)-1) << 26, // OFFSET1_CH
	ADC_OFR3_SATEN = 1UL<<25, // SATEN
	ADC_OFR3_OFFSETPOS = 1UL<<24, // OFFSETPOS
	ADC_OFR3_OFFSET1 = ((1UL<<12)-1) << 0, // OFFSET1		
};
static inline void adc_ofr3_set_offset1_ch(struct ADC_Type* p, uint32_t val) { p->OFR3 = (p->OFR3 & ~ADC_OFR3_OFFSET1_CH) | ((val<<26) & ADC_OFR3_OFFSET1_CH); }
static inline void adc_ofr3_set_offset1(struct ADC_Type* p, uint32_t val) { p->OFR3 = (p->OFR3 & ~ADC_OFR3_OFFSET1) | ((val<<0) & ADC_OFR3_OFFSET1); }
static inline uint32_t adc_ofr3_get_offset1_ch(struct ADC_Type* p) { return (p->OFR3 & ADC_OFR3_OFFSET1_CH) >> 26 ; }
static inline uint32_t adc_ofr3_get_offset1(struct ADC_Type* p) { return (p->OFR3 & ADC_OFR3_OFFSET1) >> 0 ; }

// ADC->OFR4 offset register 4
enum {
	ADC_OFR4_OFFSET1_EN = 1UL<<31, // OFFSET1_EN
	ADC_OFR4_OFFSET1_CH = ((1UL<<5)-1) << 26, // OFFSET1_CH
	ADC_OFR4_SATEN = 1UL<<25, // SATEN
	ADC_OFR4_OFFSETPOS = 1UL<<24, // OFFSETPOS
	ADC_OFR4_OFFSET1 = ((1UL<<12)-1) << 0, // OFFSET1		
};
static inline void adc_ofr4_set_offset1_ch(struct ADC_Type* p, uint32_t val) { p->OFR4 = (p->OFR4 & ~ADC_OFR4_OFFSET1_CH) | ((val<<26) & ADC_OFR4_OFFSET1_CH); }
static inline void adc_ofr4_set_offset1(struct ADC_Type* p, uint32_t val) { p->OFR4 = (p->OFR4 & ~ADC_OFR4_OFFSET1) | ((val<<0) & ADC_OFR4_OFFSET1); }
static inline uint32_t adc_ofr4_get_offset1_ch(struct ADC_Type* p) { return (p->OFR4 & ADC_OFR4_OFFSET1_CH) >> 26 ; }
static inline uint32_t adc_ofr4_get_offset1(struct ADC_Type* p) { return (p->OFR4 & ADC_OFR4_OFFSET1) >> 0 ; }

// ADC->JDR1 injected data register 1
enum {
	ADC_JDR1_JDATA1 = ((1UL<<16)-1) << 0, // JDATA1		
};
static inline uint32_t adc_jdr1_get_jdata1(struct ADC_Type* p) { return (p->JDR1 & ADC_JDR1_JDATA1) >> 0 ; }

// ADC->JDR2 injected data register 2
enum {
	ADC_JDR2_JDATA2 = ((1UL<<16)-1) << 0, // JDATA2		
};
static inline uint32_t adc_jdr2_get_jdata2(struct ADC_Type* p) { return (p->JDR2 & ADC_JDR2_JDATA2) >> 0 ; }

// ADC->JDR3 injected data register 3
enum {
	ADC_JDR3_JDATA3 = ((1UL<<16)-1) << 0, // JDATA3		
};
static inline uint32_t adc_jdr3_get_jdata3(struct ADC_Type* p) { return (p->JDR3 & ADC_JDR3_JDATA3) >> 0 ; }

// ADC->JDR4 injected data register 4
enum {
	ADC_JDR4_JDATA4 = ((1UL<<16)-1) << 0, // JDATA4		
};
static inline uint32_t adc_jdr4_get_jdata4(struct ADC_Type* p) { return (p->JDR4 & ADC_JDR4_JDATA4) >> 0 ; }

// ADC->AWD2CR Analog Watchdog 2 Configuration Register
enum {
	ADC_AWD2CR_AWD2CH = ((1UL<<19)-1) << 0, // AWD2CH		
};
static inline void adc_awd2cr_set_awd2ch(struct ADC_Type* p, uint32_t val) { p->AWD2CR = (p->AWD2CR & ~ADC_AWD2CR_AWD2CH) | ((val<<0) & ADC_AWD2CR_AWD2CH); }
static inline uint32_t adc_awd2cr_get_awd2ch(struct ADC_Type* p) { return (p->AWD2CR & ADC_AWD2CR_AWD2CH) >> 0 ; }

// ADC->AWD3CR Analog Watchdog 3 Configuration Register
enum {
	ADC_AWD3CR_AWD3CH = ((1UL<<19)-1) << 0, // AWD3CH		
};
static inline void adc_awd3cr_set_awd3ch(struct ADC_Type* p, uint32_t val) { p->AWD3CR = (p->AWD3CR & ~ADC_AWD3CR_AWD3CH) | ((val<<0) & ADC_AWD3CR_AWD3CH); }
static inline uint32_t adc_awd3cr_get_awd3ch(struct ADC_Type* p) { return (p->AWD3CR & ADC_AWD3CR_AWD3CH) >> 0 ; }

// ADC->DIFSEL Differential Mode Selection Register 2
enum {
	ADC_DIFSEL_DIFSEL_1_18 = ((1UL<<18)-1) << 1, // Differential mode for channels 15 to 1
	ADC_DIFSEL_DIFSEL_0 = 1UL<<0, // Differential mode for channels 0		
};
static inline void adc_difsel_set_difsel_1_18(struct ADC_Type* p, uint32_t val) { p->DIFSEL = (p->DIFSEL & ~ADC_DIFSEL_DIFSEL_1_18) | ((val<<1) & ADC_DIFSEL_DIFSEL_1_18); }
static inline uint32_t adc_difsel_get_difsel_1_18(struct ADC_Type* p) { return (p->DIFSEL & ADC_DIFSEL_DIFSEL_1_18) >> 1 ; }
...
static inline void adc_calfact_set_calfact_d(struct ADC_Type* p, uint32_t val) { p->CALFACT = (p->CALFACT & ~ADC_CALFACT_CALFACT_D) | ((val<<16) & ADC_CALFACT_CALFACT_D); }
static inline void adc_calfact_set_calfact_s(struct ADC_Type* p, uint32_t val) { p->CALFACT = (p->CALFACT & ~ADC_CALFACT_CALFACT_S) | ((val<<0) & ADC_CALFACT_CALFACT_S); }
static inline uint32_t adc_calfact_get_calfact_d(struct ADC_Type* p) { return (p->CALFACT & ADC_CALFACT_CALFACT_D) >> 16 ; }
static inline uint32_t adc_calfact_get_calfact_s(struct ADC_Type* p) { return (p->CALFACT & ADC_CALFACT_CALFACT_S) >> 0 ; }

// ADC->GCOMP Gain compensation Register
enum {
	ADC_GCOMP_GCOMPCOEFF = ((1UL<<14)-1) << 0, // GCOMPCOEFF		
};
static inline void adc_gcomp_set_gcompcoeff(struct ADC_Type* p, uint32_t val) { p->GCOMP = (p->GCOMP & ~ADC_GCOMP_GCOMPCOEFF) | ((val<<0) & ADC_GCOMP_GCOMPCOEFF); }
static inline uint32_t adc_gcomp_get_gcompcoeff(struct ADC_Type* p) { return (p->GCOMP & ADC_GCOMP_GCOMPCOEFF) >> 0 ; }
