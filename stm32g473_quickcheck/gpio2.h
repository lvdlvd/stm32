...
enum GPIO_Conf {
	...
	GPIO_AF2_I2C3	 = GPIO_AFOUT | 0x0200,
	GPIO_AF3_USB	 = GPIO_AFOUT | 0x0300,
	GPIO_AF4_I2C1	 = GPIO_AFOUT | 0x0400,
	GPIO_AF5_SPI1	 = GPIO_AFOUT | 0x0500,
	GPIO_AF6_SPI2	 = GPIO_AFOUT | 0x0600,
	GPIO_AF7_USART1	 = GPIO_AFOUT | 0x0700,
	GPIO_AF8_UART4	 = GPIO_AFOUT | 0x0800,
	GPIO_AF9_FDCAN	 = GPIO_AFOUT | 0x0900,
	GPIO_AF10_TIM2	 = GPIO_AFOUT | 0x0A00,
	GPIO_AF11_TIM1	 = GPIO_AFOUT | 0x0B00,
	GPIO_AF12_LPUART = GPIO_AFOUT | 0x0C00,
	GPIO_AF13_SAI1	 = GPIO_AFOUT | 0x0D00,
	GPIO_AF14_UCPD	 = GPIO_AFOUT | 0x0E00,
...
// been combined. 
//
// NOTE Unfortunately our idiom to say things like enum { LED0_PIN = PA0 } requires us to compile with -Wno-enum-conversion
// which prevents some useful error catching.  rethink this. 
enum GPIO_Pin {
	Pin_0   = 0x0001,
	Pin_1   = 0x0002,
	Pin_2   = 0x0004,
